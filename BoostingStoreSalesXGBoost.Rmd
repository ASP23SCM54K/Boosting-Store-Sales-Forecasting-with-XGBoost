...
---
```{r}
traindf <- read.csv("C:/Users/adity/Downloads/walmartsalesproject/WalmartDatasets/train.csv")
...
```{r}
storesdf <- read.csv("C:/Users/adity/Downloads/walmartsalesproject/WalmartDatasets/stores.csv")
summary(storesdf)
```


```{r}
featuresdf <- read.csv("C:/Users/adity/Downloads/walmartsalesproject/WalmartDatasets/features.csv")
summary(featuresdf)
```

```{r}
testingdf <- read.csv("C:/Users/adity/Downloads/walmartsalesproject/WalmartDatasets/test.csv")
summary(testingdf)
```
